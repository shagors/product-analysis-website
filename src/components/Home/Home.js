...
const Home = () => {
    ...
    return (
        <div>
            <div className='md:flex m-5 justify-center items-center'>
                ...
                <div className='md:home-img shadow-lg rounded ml-5 mb-5'>
            ...
            <div className='mb-5'>
                <h1 className='md:text-5xl my-5'>Customer Reviews</h1>
                <div className='md:grid grid-cols-3 gap-4 mb-5 px-3'>
                    {
